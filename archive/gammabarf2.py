...
def calcmotifscore(binscorematrix):
    ...
    tmpmatrix = []
    nonsortmatrix = []
    for bins in binscorematrix[0:41]:
...
if __name__ == "__main__":
    ...
    res = getmotiflist(motifilename, prefix = "V$E2F_03")
    ...
    for i in range(motifnum):
        ...
        plt.ylim([-300, 300])
        plt.legend((p1[0], p2[0]), ('positive score', 'negative score'), loc='upper center', bbox_to_anchor=(0.5, -0.05), ncol = 2)
        plt.savefig('gammabar_e2f_f2.eps', format = 'eps', dpi = 1200) 
